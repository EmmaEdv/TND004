...
void DSets::join(int r, int s)
{
    ...
    //Root has the negative value of the number of nodes in the tree
    //Compare the number of roots and append the tree with smaller size to the root of the other tree.
    if(root1 < root2){
